...
INSERT INTO localization_strings (`key`, `value`, language) VALUES
                                                                ...
                                                                ('error', 'Error', 'en-US'),
                                                                ('warning', 'Warning', 'en-US'),
                                                                ('information', 'Information', 'en-US'),
                                                                ('confirm', 'Confirm', 'en-US'),
                                                                ('cart_saved', 'Cart saved successfully', 'en-US'),
                                                                ('id', 'ID', 'en-US'),
                                                                ('cannot_save_empty_cart', 'Cannot save an empty cart', 'en-US'),
                                                                ('database_error', 'Database error', 'en-US'),
                                                                ('cart_cleared', 'Cart cleared successfully', 'en-US'),
                                                                ('new_cart_created', 'New cart created', 'en-US'),
                                                                ('cart_already_empty', 'Cart is already empty', 'en-US'),
                                                                ('new_cart_confirm_header', 'Start New Cart?', 'en-US'),
                                                                ('new_cart_confirm_content', 'This will clear your current cart. Are you sure?', 'en-US');;